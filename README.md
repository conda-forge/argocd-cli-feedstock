...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/argocd-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/argocd-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install argocd-cli
```
...
It is possible to list all of the versions of `argocd-cli` available on your platform:
...
```
pixi search argocd-cli --channel conda-forge
```
